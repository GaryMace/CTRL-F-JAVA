...
public class NorfolkNChance implements Bot {
	...
	public int checkExtensions(Word word, Dictionary dictionary, Board board) {
		...
		if(word.isHorizontal()) {
			...
			if(board.getSqContents(word.getStartRow(), word.getStartColumn()+word.getLength())!= Board.EMPTY) {
				suffixIndex=0;
			...
			if(board.getSqContents(word.getStartRow()+word.getLength(), word.getStartColumn())!= Board.EMPTY) {
				suffixIndex=0;

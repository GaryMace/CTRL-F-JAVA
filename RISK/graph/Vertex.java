...
public class Vertex {
    ...
    /**
     * 
     * @param territory The unique territory associated with this Vertex
     */
    public Vertex(Territory territory){
        this.label = territory.getName();
    ...
    /**
     * 
     * @return Returns territory object in node
     */
